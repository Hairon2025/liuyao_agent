...
文件位置：
- JSON：backend/running_data/divinations_json/{divination_id}.json
- Markdown：backend/running_data/divinations_md/{divination_id}.md
...
from backend.schema.api.divination import DivinationResponse
